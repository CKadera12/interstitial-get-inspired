...
(lib.greyrectangle = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#999999").ss(1,1,1).p("EgYvgk3MAxfAAAMAAABJvMgxfAAAg");
	this.shape.setTransform(0,0,1.007,1.015);
...
(lib.getinspiredwhite = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgqAxIAAhhIAhAAQAJAAAJACQAKAEAHAFQAIAGAFAJIADALIABALIgBAMIgDAKIgGAIIgHAHQgHAGgKADQgLADgHAAgAgdAlIASAAQAIAAAHgDQAIgCAFgFQAFgEAEgIIACgHIABgIIgBgHIgCgIQgEgHgFgEQgFgGgIgCQgHgCgIAAIgSAAg");
	this.shape.setTransform(41,0.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AggAxIAAhhIA+AAIAAAMIgwAAIAAAeIAtAAIAAAKIgtAAIAAAhIAzAAIAAAMg");
	this.shape_1.setTransform(31.6,0.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AASAxIgYgsIgOAAIAAAsIgOAAIAAhhIAgAAQAFAAAHABQAGACAFADQAEADADAGQADAEAAAIQAAALgGAGQgEAEgEABIgJADIAbAtgAgUgFIAPAAIAIgBIAHgCQAEgDACgDQACgCAAgFQAAgEgCgEQgCgDgDgBQgDgCgEAAIgIgCIgQAAg");
	this.shape_2.setTransform(23.4,0.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgGAxIAAhhIANAAIAABhg");
	this.shape_3.setTransform(16.8,0.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgfAxIAAhhIAdAAQAHAAAHABQAGACAFAEQAFADACAFQACAFAAAHQABAHgDAGQgDAFgFADQgEADgHABQgGACgHAAIgQAAIAAArgAgSgFIAPAAIAIAAIAHgDIAFgGQABgCAAgFQAAgEgBgDIgFgFQgDgCgEAAIgIgCIgPAAg");
	this.shape_4.setTransform(11.2,0.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(2.7,0.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAYAxIgzhPIAAAAIAABPIgNAAIAAhhIASAAIAxBOIABAAIAAhOIAOAAIAABhg");
	this.shape_6.setTransform(-6.5,0.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgGAxIAAhhIANAAIAABhg");
	this.shape_7.setTransform(-13.7,0.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgGAxIAAhVIgfAAIAAgMIBLAAIAAAMIgfAAIAABVg");
	this.shape_8.setTransform(-23,0.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AggAxIAAhhIA+AAIAAAMIgwAAIAAAeIAuAAIAAAKIguAAIAAAhIAyAAIAAAMg");
	this.shape_9.setTransform(-30.7,0.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgNAwQgJgEgHgHQgHgHgEgJQgDgKAAgLQAAgLADgJQAEgJAHgIIAIgFIAJgFQAKgDAJAAIAMAAQAFABAFACQAJADAGAGIgKAKQgEgFgHgCIgHgDIgIgBQgIAAgGAEQgIADgFAFQgFAFgCAIQgDAHAAAHQAAAIADAHQACAHAFAGQAFAFAIADQAGADAIAAIANgBIAKgEIAAgbIgVAAIAAgLIAjAAIAAAvQgIAEgJACIgUACQgKAAgLgDg");
	this.shape_10.setTransform(-40.8,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.getinspiredwhite, new cjs.Rectangle(-48.1,-10.6,96.2,21.2), null);
...
(lib.ctarectanglevideo = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#B63100").s().p("AqPCgIAAk/IUfAAIAAE/g");
	this.shape.setTransform(0.2,0.2,1.05,1.157);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.ctarectanglevideo, new cjs.Rectangle(-68.7,-18.3,137.9,37), null);
...
(lib.ctarolloverrectangle = function(mode,startPosition,loop) {
	...
	// get-inspired
	this.instance = new lib.getinspiredwhite();
	this.instance.parent = this;
	...
	// Layer 1
	this.instance_1 = new lib.ctarectanglevideo();
...
p.nominalBounds = new cjs.Rectangle(-68.6,-18.3,137.9,37);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(112).call(this.frame_112).wait(67).call(this.frame_179).wait(6));
	...
	mask_1._off = true;
	mask_1.graphics.p("AqfalIAApsMAjfAAAIAAJsg");
	mask_1.setTransform(160,170.1);

	// cta-rollover
	this.cta_rollover = new lib.ctarolloverrectangle();
	this.cta_rollover.parent = this;
	this.cta_rollover.setTransform(160,305.1,0.977,0.935,0,0,0,0.1,0.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_rollover).wait(112).to({x:3.1},0).to({x:170,alpha:1},10,cjs.Ease.get(1)).to({x:160},8,cjs.Ease.get(1)).wait(55));

	// mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	mask_2.graphics.p("AirbKIAAocIXRAAIAAIcg");
	mask_2.setTransform(131.8,173.8);
	...
	mask_3._off = true;
	mask_3.graphics.p("AqfalIAApsMAjfAAAIAAJsg");
	mask_3.setTransform(160,170.1);
	...
	this.instance_9.setTransform(375,240);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:-55},59,cjs.Ease.sineInOut).wait(126));
